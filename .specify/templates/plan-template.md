...
- Testing/verification: explicit verification steps (tests when feasible)
- UX consistency & accessibility: semantic HTML, keyboard operability, consistent styling
- Performance: dependency justification + bundle/asset impact noted
